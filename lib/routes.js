...
FlowRouter.route('/', {
  ...
  action() {
    DocHead.setTitle("Freewrite");
    DocHead.addMeta({property: 'og:image', content: 'https://www.freewrite.org/freewrite1400.png'});
    DocHead.addMeta({property: 'og:image:width', content: '1400'});
    DocHead.addMeta({property: 'og:image:height', content: '1400'});
    DocHead.addMeta({property: 'og:title', content: 'Freewrite'});
    ...
    DocHead.addMeta({property: 'og:url', content: 'https://www.freewrite.org'});
    ...
    DocHead.addMeta({property: 'twitter:title', content: 'Freewrite'});
    DocHead.addMeta({property: 'twitter:image', content: 'https://www.freewrite.org/freewrite1400.png'});
...
FlowRouter.route('/you', {
  ...
  action() {
    ...
    BlazeLayout.render('MainLayout', {main: 'you'});
  }
});
